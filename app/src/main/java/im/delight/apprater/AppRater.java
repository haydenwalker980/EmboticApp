...
public class AppRater {
    ...
    private static final String DEFAULT_TEXT_EXPLANATION = "If you enjoy using this app, would you mind taking a moment to rate it? It won't take more than a minute. Thanks for your support!";
